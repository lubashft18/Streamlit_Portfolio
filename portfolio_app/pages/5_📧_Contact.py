...
st.set_page_config(
    page_title="Antonio Luba | Contact",
    page_icon="📧",
    layout="wide",
...
# Header Section
st.markdown('<h1 class="cyber-title">CONTACT</h1>', unsafe_allow_html=True)
st.markdown('<p class="cyber-subtitle">GET IN TOUCH * CONNECT * COLLABORATE </p>', unsafe_allow_html=True)
...
with col1:
    ...
    <div class="cyber-card">
        <strong style="color: #00ffff;">📡 DIRECT CHANNELS</strong><br><br>
        <strong>📧 Email:</strong><br>
        antonioluba285@gmail.com<br><br>
        <strong>📞 Phone:</strong><br>
        +63 985 3165 737<br><br>
        <strong>📍 Location:</strong><br>
        Masbate, Philippines<br><br>
...
with col2:
    ...
    st.markdown('<strong style="color: #00ffff;">📝 SEND MESSAGE</strong><br><br>', unsafe_allow_html=True)
    
    with st.form("contact_form"):
        name = st.text_input("Full Name *", placeholder="John Doe")
        email = st.text_input("Email Address *", placeholder="john@example.com")
        subject = st.selectbox("Subject", ["Project Inquiry", "Collaboration", "Job Opportunity", "Technical Question", "Other"])
        message = st.text_area("Message *", height=150, placeholder="Tell me about your project or inquiry...")
        ...
        if submitted:
            if not name or not email or not message:
                ...
                st.info("I'll get back to you within 24-48 hours")
                st.balloons()
    st.markdown('</div>', unsafe_allow_html=True)

# ================== SOCIAL LINKS SECTION (WITH BRAND LOGOS) ==================
st.markdown("---")
st.markdown('<h3 class="cyber-subtitle">// SOCIAL //</h3>', unsafe_allow_html=True)

col1, col2, col3, col4 = st.columns(4)

with col1:
    st.markdown("""
    <a href="https://github.com/lubashft18" target="_blank" class="social-link-box">
        <div class="social-icon"><i class="fab fa-github"></i></div>
        <strong>GitHub</strong>
        <span>@lubashft18</span>
    </a>
    """, unsafe_allow_html=True)

with col2:
    st.markdown("""
    <a href="https://web.facebook.com/antonio.luba.18" target="_blank" class="social-link-box">
        <div class="social-icon"><i class="fab fa-facebook"></i></div>
        <strong>Facebook</strong>
        <span>/antonio.luba.18</span>
    </a>
    """, unsafe_allow_html=True)

with col3:
    st.markdown("""
    <a href="mailto:antonioluba285@gmail.com" target="_blank" class="social-link-box">
        <div class="social-icon"><i class="fab fa-google"></i></div>
        <strong>Gmail</strong>
        <span>antonioluba285</span>
    </a>
    """, unsafe_allow_html=True)

with col4:
    st.markdown("""
    <a href="https://lubadev.page.gd" target="_blank" class="social-link-box">
        <div class="social-icon"><i class="fas fa-code"></i></div>
        <strong>Portfolio</strong>
        <span>lubadev.page.gd</span>
    </a>
    """, unsafe_allow_html=True)
...
<div style="text-align: center; padding: 40px; background: linear-gradient(135deg, rgba(0,255,255,0.05), rgba(255,0,255,0.05)); border-radius: 15px; margin: 20px 0;">
    <div style="font-size: 1.5rem; margin-bottom: 10px;">💬 Let's Start a Conversation</div>
    <div style="color: #888; margin-bottom: 20px;">I'm just one message away. Let's build something amazing together!</div>
</div>
""", unsafe_allow_html=True)
